...
export default {
    ...
    methods: {
        ...
        addCard(title, groupId) {
            ...
            socketService.emit('change-board', { msg: `${loggedinUser.username} added a new '${title}' card`, boardId: board._id, members });
        ...
        deleteGroup(groupId) {
            ...
            const loggedinUser = this.$store.getters.loggedinUser;
            members = members.filter(memberId => memberId !== loggedinUser._id);
            socketService.emit('change-board', { msg: `${loggedinUser.username} deleted the '${board.groups[groupIdx].title}' list`, boardId: board._id, members });
        ...
        newGroup() {
            ...
            const loggedinUser = this.$store.getters.loggedinUser;
            members = members.filter(memberId => memberId !== loggedinUser._id);
            socketService.emit('change-board', { msg: `${loggedinUser.username} added a new '${newGroup.title}' list`, boardId: board._id, members });
